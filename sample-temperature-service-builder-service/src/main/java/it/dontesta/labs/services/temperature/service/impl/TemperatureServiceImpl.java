 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>it.dontesta.labs.services.temperature.service.TemperatureService</code> interface.
 *
 * <p>
...
@Component(
	property = {
		"json.web.service.context.name=dntlabs",
		"json.web.service.context.path=Temperature"
	},
...
public class TemperatureServiceImpl extends TemperatureServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use <code>it.dontesta.labs.services.temperature.service.TemperatureServiceUtil</code> to access the temperature remote service.
	 */
	@Override
