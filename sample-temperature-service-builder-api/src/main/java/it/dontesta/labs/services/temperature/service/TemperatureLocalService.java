...
public interface TemperatureLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TemperatureLocalServiceUtil} to access the temperature local service. Add custom service methods to {@link it.dontesta.labs.services.temperature.service.impl.TemperatureLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Temperature fetchTemperatureByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Temperature getTemperatureByUuidAndGroupId(java.lang.String uuid,
